...
export default function Blog() {
  ...
  const fetchData = async () => {
    try {
      ...
      const formatted: BlogPost[] = raw.slice(0, 2).map((post: any) => ({
        id: post.id,
        title: post.title,
        content: post.content, // ✅ required now
        date: post.date,
    ...
    <section id="blog" className="relative pt-20 pb-20 bg-black text-white">
      ...
      <div className="max-w-4xl mx-auto relative z-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-extrabold text-teal-400 mb-2">
            My Stories
          </h2>
          <p className="text-gray-400">
            A glimpse into my journey, thoughts, and learnings along the way.
          </p>
        </div>
