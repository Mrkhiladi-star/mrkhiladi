          ...
          <div className="lg:w-3/5 space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center p-3 bg-gray-800/50 backdrop-blur-sm rounded-lg border border-gray-700 text-sm">
                  <span className="font-semibold text-gray-200 min-w-[120px]">Full Name:</span>
                  <span className="text-gray-300">Ramu Yadav</span>
                </div>
                <div className="flex items-center p-3 bg-gray-800/50 backdrop-blur-sm rounded-lg border border-gray-700 text-sm">
                  <span className="font-semibold text-gray-200 min-w-[120px]">Date of Birth:</span>
                  <span className="text-gray-300">30th Sept 2004</span>
                </div>
                <div className="md:col-span-2 flex items-center p-3 bg-gray-800/50 backdrop-blur-sm rounded-lg border border-gray-700 text-sm">
                  <span className="font-semibold text-gray-200 min-w-[120px]">Address:</span>
                  <span className="text-gray-300">
                    Village-Dena, Post-Umari (261121), District-Sitapur, UP
                  </span>
                </div>
                <div className="flex items-center p-3 bg-gray-800/50 backdrop-blur-sm rounded-lg border border-gray-700 text-sm">
                  <span className="font-semibold text-gray-200 min-w-[120px]">Schooling:</span>
                  <span className="text-gray-300">JNV Sitapur</span>
                </div>
                <div className="flex items-center p-3 bg-gray-800/50 backdrop-blur-sm rounded-lg border border-gray-700 text-sm">
                  <span className="font-semibold text-gray-200 min-w-[120px]">Undergraduate:</span>
...
const SkillsIconCloud = () => {
  ...
  return (
    <div className="relative h-64 bg-gradient-to-br from-gray-200 to-gray-300 rounded-xl p-4 shadow-xl border border-gray-400 flex items-center justify-center">
